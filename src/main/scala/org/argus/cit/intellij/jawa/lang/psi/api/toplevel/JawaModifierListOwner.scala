...
import org.argus.cit.intellij.jawa.lang.psi.{JawaElementTypes, JawaPsiElement, JawaStubBasedPsiElementBase}
...
//        val stub: StubElement[_ <: PsiElement] = st.getStub
//        if (stub != null) {
//          val mod = stub.findChildStubByType(JawaStubElementTypes.ACCESS_FLAG)
//          if (mod != null) {
//            return mod.getPsi.hasModifierProperty(name)
//          }
//          return false
//        }
//      case _ =>
//    }
//    if (getModifierList != null) getModifierList.hasModifierProperty(name)
//    else false
//  }
//
